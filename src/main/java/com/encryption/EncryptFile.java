...
import static com.encryption.EncUI.fio;
...
public class EncryptFile {
    ...
    public static void main(String[] args){
        ...
        Option f_name = new Option("fn", "file_name", true, "Input File Name Full Path");
        f_name.setRequired(true);
        options.addOption(f_name);

        Option passwordOpt = new Option("p", "password", true, "Password for Encryption/Decryption");
        passwordOpt.setRequired(false);
        options.addOption(passwordOpt);

        Option modeOpt = new Option("m", "mode", true, "Mode (encrypt/decrypt)");
        ...
        try {
            ...
            String file_name = cmd.getOptionValue("file_name");
            String password = cmd.getOptionValue("password");
            String mode = cmd.getOptionValue("mode");
            threeArgs(mode, file_name, password);
     ...
     */
    private static void threeArgs(String mode, String filename, String password){
        ...
        if(!fio.isEncrypted(path)){
            ...
            if(mode.equals("encrypt")){
                try {
                    ...
                    String output = Encryption.encrypt(fio.getEncFile(), getUserPassword(password));
                    System.out.println("Encryption Successful");
            ...
            if(mode.equals("decrypt")){
                try {
                    System.out.println("Decrypting File...");
                    String output = Decryption.decrypt(fio.getDecFile(),getUserPassword(password));
                    System.out.println("Decryption Successful");
